...
public class AunisSoundHelperClient {
	...
	private static PositionedSoundRecord getSoundRecord(SoundPositionedEnum soundEnum, BlockPos pos) {
		return new PositionedSoundRecord(soundEnum.resourceLocation, soundEnum.soundCategory, 1.0f, 1.0f, soundEnum.repeat, 0, AttenuationType.LINEAR, pos.getX()+0.5f, pos.getY()+0.5f, pos.getZ()+0.5f);
	}
